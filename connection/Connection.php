...
class Connection {
     ...
     * for connections made using TCP/IP. The default port number is 3306.
     *
     * @var string
     */
    private $port;
    ...
    public function open(){
        ...
        /*
        * the fellowing is an alternative uri, use this uri when the server
        * donsn't request a port.
        * $uriConnection = "".$this->dbms.":host=".$this->host.";dbname=".$this->database."";
        *
        * you can find more info; http://php.net/manual/en/pdo.connections.php
        */
        $uriConnection = "".$this->dbms.":host=".$this->host.";port=".$this->port.";dbname=".$this->database."";
